...
public class JungleMainMenuScreenEnvironment {
	...
	public void setUpGameName(final JungleMainMenuScreen jungleMainMenuScreen) {
		jungleMainMenuScreen.gameName = new EmptyAbstractActorLight(420, 280,
				true);
	...
	public void setUpMounatins(final JungleMainMenuScreen jungleMainMenuScreen) {
		jungleMainMenuScreen.mountains = new EmptyAbstractActorLight(
	...
	public void setUpBackgroundBalloons(
		...
		jungleMainMenuScreen.backgroundBalloons = new ArrayList<SmartModel>();
		//
		Random rnd = new Random();
		//
		for (int i = 0; i < 30; i++) {
			float sizeWH = rnd.nextInt(60) + 40;
			SmartModel currentBalloon = new SmartModel(sizeWH, sizeWH, rnd,
					true);
			//
	...
	public void setUpFlowers(final JungleMainMenuScreen jungleMainMenuScreen) {
		jungleMainMenuScreen.flowers = new ArrayList<SmartModel>();
		//
		Random rnd = new Random();
		//
		int size = 15;
		for (int i = 0; i < size; i++) {
			...
			//
			SmartModel currentFlower = new SmartModel(wid, hei, rnd, true);
